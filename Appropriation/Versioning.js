    ...
    function quote(){
        var quoteArray = ["More than any other art form, net art entails shifts in context, since it is potentially mutable and can evolve through different versions due to contributions by the public and changes in its habitat, the Internet. (Traditional artworks can also go through different versions but these are mostly the result of a more controlled reinterpretation of the work by the artist or an art institution).","Free culture shunts aside print-era conceptions of copyright, authorship, textuality, and collective memory, and seeks to replace them with copyleft, a cultural commons that gives onto collaborative creativity, a widespread acknowledgment and acceptance of versioning (which resembles performance far more than writing), and rogue archives.","Consider the dream of hypermedia, put forth by Ted Nelson and others over the last three decades: (...) That everyone have the ability to produce their own documents, and connect them with any other public documents. That the author may constantly create new versions of his or her own document, and individuals may create their own versions of any public document."]
